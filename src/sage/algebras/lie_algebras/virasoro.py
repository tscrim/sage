...
class VirasoroAlgebra(InfinitelyGeneratedLieAlgebra, IndexedGenerators):
    ...
    def chargeless_representation(self, a, b):
        ...
        .. SEEALSO::
            ...
            :class:`~sage.algebras.lie_algebras.virasoro_repsentation.ChargelessRepresentation`
        ...
        EXAMPLES::
            ...
            Chargeless representation (3, 2) of
             The Virasoro algebra over Rational Field
        """
        from sage.algebras.lie_algebras.virasoro_repsentation import ChargelessRepresentation
    ...
    def verma_module(self, c, h):
        ...
        .. SEEALSO::
            ...
            :class:`~sage.algebras.lie_algebras.virasoro_repsentation.VermaModule`
        ...
        EXAMPLES::
            ...
            Verma module with charge 3 and conformal weight 2 of
             The Virasoro algebra over Rational Field
        """
        from sage.algebras.lie_algebras.virasoro_repsentation import VermaModule
